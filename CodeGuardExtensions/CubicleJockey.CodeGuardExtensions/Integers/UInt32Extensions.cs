...
namespace CubicleJockey.CodeGuardExtensions
{
    public static class UInt32Extensions
    {
        ...
        public static IArg<uint> IsEven(this IArg<uint> arg)
        {
            if(arg.Value%2 != 0)
            {
        ...
        /// <returns>Self</returns>
        public static IArg<uint> IsEven(this IArg<uint> arg, string message)
        {
        ...
        /// <param name="arg">Self</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsOdd(this IArg<uint> arg)
        {
            if(arg.Value%2 == 0)
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsOdd(this IArg<uint> arg, string message)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsGreaterThan(this IArg<uint> arg, uint param, string message)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsGreaterThan(this IArg<uint> arg, Func<uint> param, string message)
        {
            InternalHelpers.IsCustomMessageValid(message, nameof(IsGreaterThan));
            try
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsLessThan(this IArg<uint> arg, uint param, string message)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsLessThan(this IArg<uint> arg, Func<uint> param, string message)
        {
            InternalHelpers.IsCustomMessageValid(message, nameof(IsLessThan));
            try
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsEqual(this IArg<uint> arg, uint param, string message)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsEqual(this IArg<uint> arg, Func<uint> param, string message)
        {
            InternalHelpers.IsCustomMessageValid(message, nameof(IsEqual));
            try
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsNotEqual(this IArg<uint> arg, uint param, string message)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsNotEqual(this IArg<uint> arg, Func<uint> param, string message)
        {
            InternalHelpers.IsCustomMessageValid(message, nameof(IsNotEqual));
            try
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsInRange(this IArg<uint> arg, uint start, uint end, string message)
        {
        ...
        /// <param name="arg">Self</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsPrime(this IArg<uint> arg)
        {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsPrime(this IArg<uint> arg, string message)
        {
        ...
        /// <param name="arg">Self</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsNotPrime(this IArg<uint> arg)
        {
            if (InternalHelpers.IsPrime(arg.Value))
            {
        ...
        /// <param name="message">Custom Message</param>
        /// <returns>Self</returns>
        public static IArg<uint> IsNotPrime(this IArg<uint> arg, string message)
        {
